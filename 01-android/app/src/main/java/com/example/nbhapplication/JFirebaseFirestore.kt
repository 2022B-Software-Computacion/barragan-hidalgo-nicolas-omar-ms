...
class JFirebaseFirestore : AppCompatActivity() {
    ...
    var arreglo: ArrayList<JCitiesDto> = arrayListOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val botonOrderBy = findViewById<Button>(R.id.btn_fs_eliminar)
        botonOrderBy.setOnClickListener { consultarConOrderBy(adaptor) }

        val botonObtenerDocumento = findViewById<Button>(R.id.btn_fs_odoc)
        botonObtenerDocumento.setOnClickListener { consultarDocumento(adaptor) }

        val botonFirebaseIndiceCompuesto = findViewById<Button>(R.id.btn_fs_ind_comp)
        botonFirebaseIndiceCompuesto.setOnClickListener { consultarIndiceCompuesto(adaptor) }
    ...
    fun crearDatosEjemplo(){
        ...
        referenciaEjemploEstudiante
            ...
            .set(datosEstudiante)//Actualiza lo que crea
            .addOnCompleteListener{/*Si todo salio bien*/}
            .addOnFailureListener { /*Si algo salio mal*/ }
